    ...
    <tbody>
        ...
        foreach($Consulta as $registro){
            ...
            <tr>
                ...
                <td>
                    <a href="detalleRol.php?id=<?php echo $registro['id']; ?>" class="btn btn-info"><i class="far fa-eye"></i></a>
                    <!-- <a href="edi.php?id=<?php echo $registro['id']; ?>" class="btn btn-warning"><i class="far fa-edit"></i></a> -->
